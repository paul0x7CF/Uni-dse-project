package MSS.configuration;

import MSS.exceptions.ConfigFileReaderRuntimeException;
...
public class ConfigFileReader {
    ...
    private static final String CONFIG_FILE_PATH = "implementation/MSStorage/src/main/resources/storageConfig.properties";
