...
public class AuctionManager implements Runnable {
    ...
    private Map<UUID, TimeSlot> timeSlots = new HashMap<>();
    ...
    private void processSellQueue() throws AuctionNotFoundException {
        ...
        if (sell != null) {
            ...
            String uuid = "11a1-22a2-33a3-44a4-55a5";
            if (timeSlot.getEndTime().isBefore(LocalDateTime.now()) && timeSlot.getTimeSlotId() != UUID.fromString(uuid)) {
